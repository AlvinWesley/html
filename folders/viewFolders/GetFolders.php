...
if(isset($_POST['folder_id'])){
    ...
    $sqlFetchFiles="SELECT file_id,file_name,date_of_upload,file_size,uploader_id,file_access_level,file_path_directory,file_pseudo_name from FILES_TBL where folder_id='$folderID'";
