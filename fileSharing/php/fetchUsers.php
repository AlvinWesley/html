...
$userT=$_GET['filt']??null;
$userType="#".trim($userT)."#";
// echo "User Type ::::".$userType."\n";
// echo "User ssid ::: ".$session_id;
if($session_id){
   $user_Id=getUserId($session_id);
}
if($userType==="#nan#" || is_null($userType)){
    $sqlGetUsers=
            "SELECT 
    ...
    $sqlGetUsers=
            ...
            INNER JOIN 
                USER_LOGIN_TBL ON USER_DETAILS_TBL.user_id = USER_LOGIN_TBL.user_id
            WHERE USER_DETAILS_TBL.regStatus=1 and USER_DETAILS_TBL.user_id<>'$user_id' and user_details_tbl.user_type ='$userType';
            ";
}
